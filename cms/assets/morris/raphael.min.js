...
(function (a) {
    ...
    function cq() {
        return this.x + q + this.y + q + this.width + " Ă " + this.height
    }
    ...
    var bo      = function (b) {
        if (a.vml) {
            ...
            i.title = "RaphaĂŤl Colour Picker", i.style.display = "none", h.doc.body.appendChild(i), bo = bv(function (a) {
                i.style.color = a;
    ...
    a.findDotsAtSegment = function (a, b, c, d, e, f, g, h, i) {
        ...
        return function () {
            eve("raphael.log", null, "RaphaĂŤl: you are calling to method â" + a + "â of removed object", a)
        }
    };
    ...
    a.toString = function () {
        return "Your browser supports SVG.\nYou are running RaphaĂŤl " + this.version
    };
    var q      = function (d, e) {
        if (e) {
    ...
    z.prototype = A, A.constructor = z, a._engine.path = function (a, b) {
        ...
        this.bottom = this.top = null, (this.desc = q("desc")).appendChild(a._g.doc.createTextNode("Created with RaphaĂŤl " + a.version)), b.appendChild(this.desc), b.appendChild(this.defs = q("defs"))
