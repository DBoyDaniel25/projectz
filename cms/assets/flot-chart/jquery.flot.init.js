...
!function ($) {
     ...
     */
        FlotChart.prototype.init = function (pieChart) {
            //plot graph data
            ...
            var colors, datas, pielabels;
            if (pieChart) {
                pielabels = pieChart.getLabels();
                datas     = pieChart.getData();
                colors    = pieChart.getColors();
            } else {
                pielabels = ["Series 1", "Series 2", "Series 3"];
                datas     = [20, 40, 60];
                colors    = ["#60b1cc", "#6c85bd", "#1ca8dd"];
            }
